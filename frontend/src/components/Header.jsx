  ...
  const handleLogout = () => {
    Swal.fire({
      ...
      customClass: {
        ...
        confirmButton:
          "px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold shadow-md shadow-blue-500/25 hover:shadow-lg hover:shadow-blue-500/30 hover:scale-105 active:scale-95 transition-all duration-300",
        cancelButton:
...
flex-shrink-0"
  ...
  font-semibold 
  shadow-sm sm:shadow-md shadow-blue-500/25 
  text-xs xs:text-sm"
              >
  ...
  border-[1.5px] xs:border-2 border-white"
              >
          ...
          <button
            ...
            className="hidden md:inline-flex items-center gap-1.5 md:gap-2 px-3 md:px-4 lg:px-5 py-1.5 md:py-2 lg:py-2.5 
  bg-gradient-to-r from-blue-600 to-indigo-600 
  hover:from-blue-700 hover:to-indigo-700 
  text-white text-xs md:text-sm font-medium 
  rounded-lg md:rounded-xl 
  shadow-md md:shadow-lg shadow-blue-500/25 
