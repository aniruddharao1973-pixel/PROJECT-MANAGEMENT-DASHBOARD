    ...
    <BaseModal open={open} onClose={handleClose} title="">
      <div className="modal-content">
        ...
        <div className="relative mb-6">
          {/* Background glow */}
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-100 via-transparent to-purple-100 blur-2xl opacity-40 rounded-xl" />

          <div className="relative flex items-center gap-4">
            {/* Icon Section */}
            <div className="relative">
              <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg">
