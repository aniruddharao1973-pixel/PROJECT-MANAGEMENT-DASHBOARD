  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="relative w-full max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl max-h-[95vh] sm:max-h-[90vh] bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-modalSlideIn">
        {/* Decorative Elements */}
        <div className="absolute top-0 right-0 w-48 sm:w-64 md:w-80 lg:w-96 h-48 sm:h-64 md:h-80 lg:h-96 bg-gradient-to-br from-blue-400/10 to-indigo-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-32 sm:w-48 md:w-56 lg:w-64 h-32 sm:h-48 md:h-56 lg:h-64 bg-gradient-to-tr from-blue-400/10 to-indigo-500/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />

        {/* Header */}
        <div className="relative overflow-hidden flex-shrink-0">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700" />
          <div
        ...
        <div className="flex-1 overflow-y-auto bg-gradient-to-b from-slate-50 to-white overscroll-contain">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16 sm:py-20 md:py-24">
              <div className="relative">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 border-3 sm:border-4 border-blue-100 rounded-full" />
                <div className="absolute top-0 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 border-3 sm:border-4 border-indigo-500 border-t-transparent rounded-full animate-spin" />
                <div className="absolute top-1.5 left-1.5 sm:top-2 sm:left-2 w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 border-3 sm:border-4 border-blue-300 border-t-transparent rounded-full animate-spin animation-delay-150" />
              </div>
                                ...
                                >
                                  ...
                                  <div
                                    className={`relative w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md transition-transform duration-200 group-hover:scale-105 ${
                                      isCustomerDocuments
                                        ? "bg-gradient-to-br from-indigo-500 to-blue-600 shadow-violet-500/30"
                                        : isSubfolder
                                  ...
                                  <div className="min-w-0">
                                    <p className="font-semibold text-sm sm:text-base text-slate-900 group-hover:text-indigo-700 transition-colors truncate">
                                      {f.name}
                                    </p>
                                    <div className="flex items-center gap-2 mt-0.5">
                                      ...
                                      {isCustomerDocuments && (
                                        <span className="inline-flex items-center gap-1 px-1.5 sm:px-2 py-0.5 bg-blue-100 text-indigo-700 text-[10px] sm:text-xs font-bold rounded-full">
                  ...
                  return (
                    <div
                      ...
                      className={`bg-white rounded-xl sm:rounded-2xl shadow-lg shadow-slate-200/50 border overflow-hidden transition-all duration-200 hover:shadow-xl ${
                        isCustomerDocuments
                          ? "border-indigo-200 bg-gradient-to-br from-blue-50/50 to-white"
                          : "border-slate-200"
                      }`}
                    >
                      {/* Folder Header */}
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                          <div
                            className={`relative w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg flex-shrink-0 ${
                              isCustomerDocuments
                                ? "bg-gradient-to-br from-blue-500 to-indigo-600 shadow-violet-500/30"
                                : isSubfolder
                                  ? "bg-gradient-to-br from-slate-200 to-slate-300 shadow-slate-300/30"
                          ...
                          >
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                              ...
                              <div
                                ...
                                ${
                                  f[perm.key] ? "bg-indigo-500" : "bg-slate-200"
                                }`}
                              />
                            </label>
                          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex-1 sm:flex-initial px-5 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm sm:text-base font-semibold rounded-lg sm:rounded-xl flex items-center justify-center gap-2 sm:gap-2.5 active:scale-[0.98] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/30 hover:shadow-xl hover:shadow-indigo-500/40"
              >
                {saving ? (
                  <>
