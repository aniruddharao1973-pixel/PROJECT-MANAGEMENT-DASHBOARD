...
const VersionsModal = ({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div className="w-[95vw] max-w-5xl max-h-[90vh] rounded-2xl shadow-2xl overflow-hidden bg-gradient-to-br from-white/95 to-indigo-50/95 border border-indigo-200 backdrop-blur-xl flex flex-col">
          {/* Header */}
          <div className="flex justify-between items-center px-6 py-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700">
          ...
          <div className="p-5 max-h-[70vh] overflow-y-auto custom-scrollbar">
            {localVersions.length === 0 ? (
              ...
              <table className="w-full bg-white rounded-xl shadow border border-gray-200">
                <thead className="bg-indigo-50 border-b sticky top-0 z-50">
                  ...
                  {paginatedVersions.map((v, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        ${isExpanded ? "bg-blue-50" : "hover:bg-indigo-50/40"}
          ...
          : "bg-gray-200 text-gray-500 cursor-not-allowed"
                            ...
                            {isVersionRow && !isCustomer && (
                              <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 font-semibold rounded-lg shadow transition bg-purple-100 text-indigo-700 hover:bg-purple-200 hover:scale-105"
                              >
                                📊 Tracking
                              </button>
                            )}
                        ...
                        {/* EXPANDED PANEL */}
                        {isExpanded && (
                          <tr className="bg-indigo-50/40 border-b transition-all duration-300">
                            <td></td>
                            ...
                            <td colSpan={5} className="p-5 space-y-5 text-sm">
                              ...
                              <div className="mb-3">
                                {/* ===== CUSTOMER VIEW ===== */}
                                {["customer", "collaborator"].includes(
                                  user?.role,
                                ) && (
                                  <>
                                    ...
                                    {doc.review_status !== "approved" && (
                                      <div className="px-3 py-2 bg-indigo-50 text-gray-700 rounded-lg text-sm font-semibold">
                                ...
                                {/* ===== INTERNAL USERS VIEW ===== */}
                                {["admin", "techsales", "department"].includes(
                                  user?.role,
                                ) && (
                                  <>
                              ...
                              {user &&
                                ...
                                doc.current_version === v.version_number && (
                                  <div className="p-4 bg-indigo-50 border border-indigo-200 rounded-lg flex gap-4 items-center">
                                    <button
