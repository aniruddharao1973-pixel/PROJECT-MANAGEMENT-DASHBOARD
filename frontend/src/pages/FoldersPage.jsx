        ...
        <div className="text-center space-y-4 sm:space-y-6">
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <p className="text-xs sm:text-sm lg:text-base text-gray-500">
              Please wait we are about to Fetch Folder details and Files...
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
          ...
          <header className="relative bg-white/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-br from-blue-100/50 to-indigo-100/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
            ...
            <div className="relative px-4 sm:px-5 md:px-6 py-6 sm:py-8">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div className="flex items-start sm:items-center gap-4 sm:gap-5">
                  {/* Folder Icon */}
                  <div className="p-2.5 sm:p-3 bg-gradient-to-br from-blue-500 via-indigo-500 to-blue-600 rounded-xl shadow-lg shadow-blue-500/30">
          ...
          <section>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-5 sm:mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2 sm:p-2.5 bg-gradient-to-br from-blue-500 via-indigo-500 to-blue-600 rounded-lg sm:rounded-xl shadow-md shadow-blue-500/25">
      ...
      "
                        ...
                        <div className="mt-5 pt-4 border-t border-gray-100 flex items-center justify-between">
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              if (isCustomerLike && !folder.customer_can_view) {
                                toast.warning(
