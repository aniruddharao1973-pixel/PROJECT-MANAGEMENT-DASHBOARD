...
//   const { getTeamRecycleBinDocuments } = useDocumentsApi();
//   const { getTeamRecycleBinFolders } = useFoldersApi();
...
//         getTeamRecycleBinDocuments(),
//         getTeamRecycleBinFolders(),
//       ]);
...
//   return (
//     <div className="w-full bg-gradient-to-br from-gray-50 via-white to-gray-50 p-4 sm:p-6 lg:p-8">
        ...
        <div className="text-center space-y-4 sm:space-y-6">
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <p className="text-xs sm:text-sm lg:text-base text-gray-500">
              Please wait we are about to Fetch Recycle Bin Folders & Files...
            </p>
          </div>
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* ================= INFO ================= */}
        {totalItems > 0 && (
          <div className="mt-10 p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-200">
