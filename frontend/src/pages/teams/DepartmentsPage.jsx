...
export default function DepartmentsPage() {
  ...
  const handleDeleteDepartment = async (dept) => {
    ...
    const result = await Swal.fire({
      title: "Delete department?",
      html: `
    <p>This action will <b>permanently delete:</b></p>
    <div style="
      margin-top:10px;
      padding:12px;
      border-radius:10px;
  ...
  `,
      ...
      buttonsStyling: false, // important for custom styles
  ...
  return (
    ...
    shadow-sm hover:shadow-md hover:scale-105 transition-all duration-300"
                >
                  <div className="relative">
                    <Building2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 group-hover:rotate-12 transition-transform duration-300" />
      ...
      shadow-sm hover:shadow-md hover:scale-105 transition-all duration-300"
                  >
                    <span className="p-0.5 sm:p-1 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 group-hover:rotate-180 transition-transform duration-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
                ...
                <div className="group relative bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-slate-200/60 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                  ...
                  <div className="relative flex items-center justify-between">
                    {/* TEXT */}
                    <div>
                      <p className="text-xs font-medium text-slate-500 mb-1 group-hover:text-blue-600 transition-colors">
                        Total Departments
                      </p>

                      <p className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-500 via-indigo-500 to-indigo-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300 inline-block">
                        {departments.length}
                      </p>
                    </div>
                    ...
                    {/* ICON */}
                    <div className="relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-indigo-500 to-indigo-600 rounded-lg sm:rounded-xl blur-lg opacity-0 group-hover:opacity-60 transition-opacity duration-300"></div>

                      <div className="relative p-2.5 sm:p-3 bg-gradient-to-br from-blue-100 via-indigo-100 to-indigo-100 rounded-lg sm:rounded-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-md shadow-indigo-500/20">
                  ...
                  <div className="relative mt-3 sm:mt-4 h-1 bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="absolute inset-y-0 left-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full transition-all duration-1000 ease-out group-hover:w-full"
                      style={{ width: "70%" }}
                    ></div>
                  </div>
                </div>
                ...
                <div
                  ...
                  className="group cursor-pointer relative overflow-hidden rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-indigo-200/40 bg-gradient-to-br from-white/70 via-blue-50/40 to-indigo-50/30 backdrop-blur-sm shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-indigo-300 sm:col-span-2 lg:col-span-1"
                >
                  {/* Shine */}
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/30 to-transparent"></div>
                  ...
                  <div className="relative flex items-center justify-between">
                    ...
                    {/* ICON */}
                    <div className="relative p-2.5 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-md shadow-indigo-500/20 transition-all duration-300 group-hover:scale-110 group-hover:rotate-12">
                  ...
                  <div className="relative mt-3 sm:mt-4 flex items-center gap-1.5 sm:gap-2">
                    <div className="flex-1 h-1 bg-slate-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full group-hover:animate-pulse"
                        style={{ width: "60%" }}
                      ></div>
                    </div>
    ...
    border border-slate-200/60 
    shadow-sm hover:shadow-xl hover:shadow-indigo-500/10 sm:hover:shadow-2xl
    transition-all duration-300 
    ...
    overflow-hidden"
                  ...
                  >
                    ...
                    {/* Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/40 via-transparent to-blue-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                    {/* Ambient glow */}
                    <div className="pointer-events-none absolute -top-4 -right-4 sm:-top-6 sm:-right-6 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-blue-300/20 to-indigo-300/20 rounded-full blur-2xl sm:blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    ...
                    <div className="relative">
                      ...
                      <div className="flex justify-between items-start mb-4 sm:mb-5">
                        ...
                        <div className="relative">
                          ...
                          <div className="relative p-2.5 sm:p-3 md:p-3.5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-md transition-all duration-300 group-hover:shadow-lg">
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="p-2 sm:p-2.5 rounded-lg sm:rounded-xl bg-slate-100/50 hover:bg-gradient-to-br hover:from-blue-100 hover:to-indigo-100
              text-slate-500 hover:text-indigo-600 transition-all duration-300 hover:scale-110 hover:rotate-90 shadow-sm hover:shadow-md"
                          >
                          ...
                          {openMenuId === dept.id && (
                            <div
                              onClick={(e) => e.stopPropagation()}
                              className="absolute right-0 mt-2 bg-white/95 backdrop-blur-md border border-slate-200/80 rounded-xl sm:rounded-2xl shadow-2xl shadow-slate-300/50 z-20 p-1.5 sm:p-2 flex items-center justify-center gap-2"
                            >
                              <button
                                onClick={() => {
                                  setOpenMenuId(null);
                                ...
                                className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-lg sm:rounded-xl text-slate-400 hover:text-red-600 hover:bg-red-50 transition-all duration-300 hover:scale-110"
                              >
                      ...
                      <div className="flex items-start justify-between gap-2 sm:gap-3 mb-2.5 sm:mb-3">
                        <h3 className="text-base sm:text-lg md:text-xl font-bold text-slate-900 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-indigo-600 group-hover:bg-clip-text transition-all duration-300">
                          {dept.name}
                        </h3>
                        ...
                        <button
                          ...
                          className="p-1.5 sm:p-2 rounded-lg bg-gradient-to-br from-slate-100 to-slate-50 hover:from-blue-100 hover:to-indigo-100 text-slate-500 hover:text-indigo-600 transition-all duration-300 hover:scale-110 hover:-rotate-12 shadow-sm hover:shadow-md"
                        >
                      ...
                      {dept.email ? (
                        <div
                          ...
                          className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg text-xs sm:text-sm font-medium bg-gradient-to-r from-blue-50 to-indigo-50 text-indigo-600 hover:from-blue-100 hover:to-indigo-100 cursor-pointer mb-3 sm:mb-4 transition-all duration-300 hover:scale-105 hover:shadow-md border border-blue-100"
                        >
                      ...
                      <div className="pt-3 sm:pt-4 border-t border-slate-100 group-hover:border-indigo-100 transition-colors duration-300">
                        <div className="flex items-center gap-1.5 sm:gap-2">
                          <div className="p-1 sm:p-1.5 rounded-lg bg-slate-50 group-hover:bg-gradient-to-br group-hover:from-blue-50 group-hover:to-indigo-50 transition-all duration-300">
                            <FolderOpen className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-400 group-hover:text-indigo-500" />
                          </div>
